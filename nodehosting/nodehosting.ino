...
const char* server="specialcorp2.000webhostapp.com";
...
//  Serial.println(Firebase.getInt("value"));
  ...
  String Link = "http://"+String(server)+"/kirimdata.php?suhu=" + String(suhu) + "&kelembapan=" +String(kelembapan) +"&cahaya=" +String(ldrstatus)+ "&tanah=" +String(moisture);
  //eksekusi 
...
//  http.begin(Link);
  ...
  LinkPompa = "http://" + String(server) + "/dashboard-control/bacapompa.php";
  ...
  LinkLampu = "http://" + String(server) + "/dashboard-control/bacalampu.php";
